...
- **Readable option explanations** — the colour-style / flip-style hints are bullet points (one line per style, key word in bold) instead of a dense paragraph, and the **Auto** switch says plainly what ON and OFF do
